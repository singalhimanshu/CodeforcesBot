...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 71 + 51) / 103)
exe '2resize ' . ((&lines * 11 + 13) / 27)
exe 'vert 2resize ' . ((&columns * 31 + 51) / 103)
exe '3resize ' . ((&lines * 13 + 13) / 27)
exe 'vert 3resize ' . ((&columns * 31 + 51) / 103)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
